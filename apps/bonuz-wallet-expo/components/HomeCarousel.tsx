...
export default function HomeCarousel({title,lineargradient,start,end, right,badgeCount,item,data,activeIndex,setActiveIndex,style}) {
  return (
    <LinearGradient
    start={start? start :[0, 0.4]}
    end={end ? end :[0.2, 0.7]}
    colors={lineargradient ? lineargradient :["#63ADEF", "#4E35B1"]}
