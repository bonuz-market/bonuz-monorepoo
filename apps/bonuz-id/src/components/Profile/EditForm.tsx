        ...
        <div className='flex flex-col justify-around gap-4 lg:flex-row mt-10 max-h-[50vh] overflow-y-auto px-2'>
          <div>
            ...
            <div className='flex flex-col items-start justify-start mt-4'>
              ...
              <label className='text-xl font-medium mt-2' htmlFor='handle'>
                Handle
              </label>

              <div>
                <div className='flex items-center justify-start gap-2 rounded-lg w-full px-2 py-3 sm:px-5 backdrop-blur-md bg-white/30'>
                  <span className='text-neutral-50'>@</span>
                  <input
                    // className='rounded-lg w-full px-2 py-3 sm:px-5 backdrop-blur-md bg-white/30'
                    className='placeholder-slate-300 bg-transparent border-none w-full text-white outline-none focus:border-none focus-visible:shadow-none'
                    type='text'
                    placeholder='Handle'
                    id='handle'
                    {...register('handle', {
          ...
          <div className='flex flex-col space-y-5'>
            <div className='grid gap-4 lg:grid-cols-1 xl:grid-cols-2'>
              <h4 className='col-span-full'>Social Accounts</h4>
