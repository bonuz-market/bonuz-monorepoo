...
const EditForm = ({
  ...
  return (
    <form onSubmit={onSubmit}>
      <div className="flex flex-col justify-around gap-4 lg:flex-row mt-10">
        <div>

          <div className="flex items-start justify-center sm:flex-col sm:items-center sm:justify-start">
            <div className="shape-outer hexagon absolute top-[-80px] z-10 sm:relative sm:top-[0px]">
              <Controller
                name="profileImage"
                control={control}
          ...
          <div className="grid gap-4 lg:grid-cols-1 xl:grid-cols-2">
            ...
            {defaultValues?.links?.socialMedias &&
              Object.entries(defaultValues?.links?.socialMedias).map(
                ([key, value]) => {
                  const { baseUrl, icon, imgSrc, isVerified,
                    isTwitterVerified,
            ...
            {defaultValues?.links?.messengers &&
              Object.entries(defaultValues?.links?.messengers).map(
                ([key, value]) => {
                  ...
                  const isPublicKey = `links.messengers.${key}.isPublic` as any;
      ...
      <div className="ms-auto mt-8 flex w-full justify-end gap-4 lg:w-max">
        <Button
          transition
