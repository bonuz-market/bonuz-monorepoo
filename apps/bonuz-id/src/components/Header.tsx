  ...
  return (
    <>
      <div
        ...
        <div className='hidden sm:flex gap-0.5 justify-between items-start self-stretch my-auto cursor-pointer' 
        ...
        <div className='flex flex-1 items-center justify-center w-full'>
          <div className='mt-2 w-full h-[40px] flex items-center justify-center p-3 pt-0 gap-2 rounded-[30px] border-2 pb-0 border-[#9651FF]'>
            <Image
